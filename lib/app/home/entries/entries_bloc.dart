...
import 'package:time_tracker_flutter/app/home/entries/daily_jobs_details.dart';
import 'package:time_tracker_flutter/app/home/entries/entries_list_tile.dart';
import 'package:time_tracker_flutter/app/home/entries/entry_job.dart';
...
class EntriesBloc {
  ...
  Stream<List<EntryJob>> get _allEntriesStream => Rx.combineLatest2(
        database.entriesStream(job: null),
        database.jobsStream(),
